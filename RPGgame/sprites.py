...
class Player(pygame.sprite.Sprite):
	...
	# Colliding against a player and what the result of the collition does
...
# Collition into objects AND CAM FOCUS ON PLAYER
		...
		if direction == "x":
			...
			if hits:
				if self.x_change > 0:
					...
					# SO THE CAM STAYS ON THE PLAYER
					for sprite in self.game.all_sprites:
						sprite.rect.x += PLAYER_SPEED
